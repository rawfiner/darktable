 ...
 *  |  f(0.5), f(-0.5), f(-1.5), f(-2.5), f(-3.5), f(-4.5), 1 |
 *  |  f(1.5),  f(0.5), f(-0.5), f(-1.5), f(-2.5), f(-3.5), 1 |
 *  |  f(2.5),  f(1.5),  f(0.5), f(-0.5), f(-1.5), f(-2.5), 1 |
 *  |  f(3.5),  f(2.5),  f(1.5),  f(0.5), f(-0.5), f(-1.5), 1 |
 *  |  f(4.5),  f(3.5),  f(2.5),  f(1.5),  f(0.5), f(-0.5), 1 |
 *  ⎣  f(5.5),  f(4.5),  f(3.5),  f(2.5),  f(1.5),  f(0.5), 1 ⎦
 *
 * Let's compute all the f(x).
 * M =
 *  ⎡  0.476299757397,    1.2490457724,   1.50595749709,   1.55090213305,   1.56224952636,   1.56634141689, 1 ⎤
 *  | -0.476299757397,  0.476299757397,    1.2490457724,   1.50595749709,   1.55090213305,   1.56224952636, 1 |
 *  |   -1.2490457724, -0.476299757397,  0.476299757397,    1.2490457724,   1.50595749709,   1.55090213305, 1 |
 *  |  -1.50595749709,   -1.2490457724, -0.476299757397,  0.476299757397,    1.2490457724,   1.50595749709, 1 |
 *  |  -1.55090213305,  -1.50595749709,   -1.2490457724, -0.476299757397,  0.476299757397,    1.2490457724, 1 |
 *  |  -1.56224952636,  -1.55090213305,  -1.50595749709,   -1.2490457724, -0.476299757397,  0.476299757397, 1 |
 *  ⎣  -1.56634141689,  -1.56224952636,  -1.55090213305,  -1.50595749709,   -1.2490457724, -0.476299757397, 1 ⎦
 *
 * Now, let's invert M.
 * M⁻¹ =
 ...
 * [  1.23426519  -0.69835949  -0.87930953   1.68680764  -0.87930953   -0.69835949   1.23426519]]
 *
